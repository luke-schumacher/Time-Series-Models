"""
Train SeqofSeq Sequence Model from Scratch

Trains the ConditionalSequenceGenerator to predict scan sequence tokens
conditioned on patient/scan context (BodyPart, SystemType, Country, Group, coil configuration, entity_type).
"""
...
from SeqofSeq_Pipeline.config import SEQUENCE_MODEL_CONFIG, PAD_TOKEN_ID
...
def train_seqofseq_sequence_model(
    batch_size=32,
    epochs=100,
    ...
    print("=" * 70)
    print("TRAINING SEQOFSEQ SEQUENCE MODEL")
    print("=" * 70)
...
if __name__ == "__main__":
    ...
    print("\n[SUCCESS] SeqofSeq sequence model training complete!")
